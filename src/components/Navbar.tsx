  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full max-w-screen-xl items-center justify-between px-4 py-1">
        <a
          href="/"
          className="flex w-1/6 items-center justify-center space-x-3 rtl:space-x-reverse"
        >
        ...
        {navLinks.map(({ href, name }) => (
          <a
            ...
            className={classNames(
              ...
              "hidden w-1/6 rounded py-2 text-center  text-xl uppercase text-gray-900 hover:bg-gray-100 md:block md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-gray-700",
            )}
          >
            {name}
          </a>
